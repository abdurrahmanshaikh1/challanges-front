...
const userRatings = [
  ...
  const filteredProducts = useMemo(() => {
    ...
    const priceRange = priceRanges.find((pr) => pr.label === selectedPriceLabel);
    if (priceRange && selectedPriceLabel !== 'All Prices') {
    ...
    return result;
  }, [selectedBrand, selectedCategory, selectedPriceLabel]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white flex">
      ...
      <main className="flex-1 px-8 py-6 overflow-y-auto">
        ...
        {/* Filters */}
        <section className="mb-6 bg-slate-900/80 border border-slate-800 rounded-xl px-5 py-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <select
                ...
                className="bg-slate-950/70 border border-slate-800 rounded-lg px-3 py-2 text-sm text-slate-200 focus:outline-none focus:ring-2 focus:ring-cyan-500/40"
              >
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <select
                ...
                onChange={handleFilterChange(setSelectedPriceLabel)}
                className="bg-slate-950/70 border border-slate-800 rounded-lg px-3 py-2 text-sm text-slate-200 focus:outline-none focus:ring-2 focus:ring-cyan-500/40"
              >
                {priceRanges.map((pr) => (
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {currentProducts.map((item) => (
            <article
              key={item.id}
              className="bg-slate-900/80 border border-slate-800 rounded-xl overflow-hidden shadow-md hover:shadow-xl hover:-translate-y-1 transition-transform duration-200"
            >
              <div className="relative h-44 bg-slate-800 overflow-hidden">
                ...
                />
                <span className="absolute top-3 left-3 text-[11px] px-2 py-1 rounded-full bg-black/70 text-slate-100">
                  {item.brand}
                </span>
              </div>
              ...
              <div className="px-4 pt-3 pb-4 flex flex-col gap-2">
                ...
                <button
                  ...
                  className={`mt-2 w-full text-sm font-medium py-2 rounded-lg transition ${
                    item.inStock
